...
def avg_data_2013():
    temp_i=0
    average=[]
    for rows in pd.read_csv(r'\Data\AQI\aqi2013.csv',chunksize=24):
        add_var=0
        avg=0.0
        data=[]
...
def avg_data_2014():
    temp_i=0
    average=[]
    for rows in pd.read_csv(r'\Data\AQI\aqi2014.csv',chunksize=24):
        add_var=0
        avg=0.0
        data=[]
        df=pd.DataFrame(data=rows)
...
def avg_data_2015():
    temp_i=0
    average=[]
    for rows in pd.read_csv(r'\Data\AQI\aqi2015.csv',chunksize=24):
        add_var=0
        avg=0.0
        data=[]
        df=pd.DataFrame(data=rows)
...
def avg_data_2016():
    temp_i=0
    average=[]
    for rows in pd.read_csv(r'\Data\AQI\aqi2016.csv',chunksize=24):
        add_var=0
        avg=0.0
        data=[]
        df=pd.DataFrame(data=rows)
...
def avg_data_2017():
    temp_i=0
    average=[]
    for rows in pd.read_csv(r'\Data\AQI\aqi2017.csv',chunksize=24):
        add_var=0
        avg=0.0
        data=[]
        df=pd.DataFrame(data=rows)
...
def avg_data_2018():
    temp_i=0
    average=[]
    for rows in pd.read_csv(r'\Data\AQI\aqi2018.csv',chunksize=24):
        add_var=0
        avg=0.0
        data=[]
        df=pd.DataFrame(data=rows)
...
#    temp_i=0
#    average=[]
#    for rows in pd.read_csv(r'\Data\AQI\aqi{}.csv'.format(year),chunksize=24):
#       add_var=0
#        avg=0.0
#        data=[]
#        df=pd.DataFrame(data=rows)
